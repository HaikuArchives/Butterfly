...
{
public:
	CaptionView(BRect frame, const char *name, const char *caption);
	~CaptionView();
...
private:
	...
	CaptionView *config_caption;
	BView *config_view;
	OutputFormat *output_list;
	BWindow *the_window;
	int32 index;
...
CaptionView::CaptionView(BRect frame, const char *name, const char *caption)
